package pl.cyfrowypolsat.cpcommon.data.ntp;
...
public class SNTPClient {
    ...
    public static class NPTResult {
        public String rawDate;
        public Date date;
        public NPTResult(String rawDate, Date date) {
    ...
    public static Observable<Date> getCurrentDate(String host) {
        String validHost = host != null ? host : "time.google.com";
        return Observable.fromCallable(() -> {
            SNTPClient sntpClient = new SNTPClient();
            sntpClient.requestTime(validHost, 5000);

            long nowAsPerDeviceTimeZone = sntpClient.getNtpTime();
            String rawDate = SIMPLE_DATE_FORMAT.format(nowAsPerDeviceTimeZone);
            return SIMPLE_DATE_FORMAT.parse(rawDate);
        });
    }
}